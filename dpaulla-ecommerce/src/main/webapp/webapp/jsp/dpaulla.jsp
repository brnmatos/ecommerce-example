...
<body class="body-left">
	...
	<div class="section-home">
		<div class="slideshow-container">
			<h1 class="titulo-DPaulla">IMPERDÍVEL</h1>

			<div class="mySlides fade">
				<img src="assets/images/promocao1.jpg" class="carousel-img">
				<div class="text-slider white-link">promocao1.jpg</div>
			</div>
			<div class="mySlides fade">
				<img src="assets/images/promocao2.jpg" class="carousel-img">
				<div class="text-slider white-link">promocao2.jpg</div>
			</div>
			<div class="mySlides fade">
				<img src="assets/images/promocao3.jpg" class="carousel-img">
				<div class="text-slider white-link">promocao3.jpg</div>
			</div>
			<div style="text-align: center" class="myDot">
